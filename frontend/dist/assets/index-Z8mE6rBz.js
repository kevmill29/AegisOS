...
`)+`
`+c);const _=g+p+o,y=g+c+a,R=Rp(r,r.VERTEX_SHADER,_),A=Rp(r,r.FRAGMENT_SHADER,y);r.attachShader(S,R),r.attachShader(S,A),n.index0AttributeName!==void 0?r.bindAttribLocation(S,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(S,0,"position"),r.linkProgram(S);function w(T){if(t.debug.checkShaderErrors){const B=r.getProgramInfoLog(S).trim(),z=r.getShaderInfoLog(R).trim(),q=r.getShaderInfoLog(A).trim();let Q=!0,V=!0;if(r.getProgramParameter(S,r.LINK_STATUS)===!1)if(Q=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,S,R,A);else{const Z=Pp(r,R,"vertex"),b=Pp(r,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(S,r.VALIDATE_STATUS)+`
